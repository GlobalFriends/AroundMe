...
interface AroundMeDBSchema {
    ...
    public final static String CREATE_PHOTO_REFERNCE_TABLE = "CREATE TABLE "
            + AroundMeContractProvider.PhotoRefernce.TABLENAME
            + " ( "
            + AroundMeContractProvider.PhotoReferenceColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT , "
            + AroundMeContractProvider.PhotoReferenceColumns.PHOTO_HEIGHT + " INTEGER , "
            + AroundMeContractProvider.PhotoReferenceColumns.PHOTO_WIDTH + " INTEGER ,"
            + AroundMeContractProvider.PhotoReferenceColumns.PHOTO_PLACE_ID + " TEXT NOT NULL,"
            + AroundMeContractProvider.PhotoReferenceColumns.URL + " TEXT ,"
            + AroundMeContractProvider.PhotoReferenceColumns.PHOTO_URL + " TEXT ,"
            + AroundMeContractProvider.PhotoReferenceColumns.PHOTO_REF + " TEXT "
            + " )";
