...
public class SettingsFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        //APk Version
        final Preference version = (Preference) findPreference("software_version");
        try {
            PackageInfo pinfo = AroundMeApplication.getContext().getPackageManager().getPackageInfo(
                    AroundMeApplication.getContext().getPackageName(), 0);
